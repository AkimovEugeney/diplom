import { svgContactDelete } from './svg.js'
...
export function createContactItem() {
  ...
  contactDelete.addEventListener('click', e => {
    ...
    document
      ...
      .classList.add('modal__btn-contact_active')
  })

  contactName.addEventListener('click', e => {
    e.preventDefault()
    contactList.classList.toggle('cotact__list_active')
    contactName.classList.toggle('contact__list_active')
  })

  contactType.addEventListener('mouseleave', () => {
    contactList.classList.remove('cotact__list_active')
